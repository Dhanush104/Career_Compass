...
const steps = [
  {
    title: "1. DISCOVER",
    desc: "Find your best career path with our AI-driven quiz.",
    icon: "🔍",
  },
  {
    title: "2. PLAN",
    desc: "Get step-by-step personalized roadmaps.",
    icon: "📝",
  },
  {
    title: "3. GROW",
    desc: "Stay consistent with daily tasks and gamified progress.",
    icon: "🌱",
  },
];
...
const testimonials = [
  {
    ...
    feedback: "This platform transformed my career journey. The AI-driven roadmap was super helpful!",
    avatar: "https://i.pravatar.cc/100?img=1",
  },
  {
    name: "Mark Williams",
    role: "Data Analyst",
    feedback: "I loved the gamified tasks and mentorship hub. Highly recommended for anyone starting out!",
    avatar: "https://i.pravatar.cc/100?img=2",
  },
  {
    name: "Sophia Lee",
    role: "UX Designer",
    feedback: "The community and portfolio builder made a huge difference in getting noticed by recruiters.",
    avatar: "https://i.pravatar.cc/100?img=3",
  },
];

const futureScopes = [
  { title: "AI-generated tasks", icon: "🤖", description: "Intelligent tasks tailored to your learning pace and style." },
  { title: "Mentorship hub", icon: "🎓", description: "Connect with mentors to guide your career and personal growth." },
  { title: "Peer communities", icon: "🌐", description: "Collaborate with like-minded peers in focused communities." },
  { title: "Portfolio builder", icon: "📁", description: "Create and showcase your projects to impress recruiters and mentors." },
  { title: "Job matching", icon: "💼", description: "Receive personalized job and internship recommendations." },
  { title: "Skill analytics", icon: "📊", description: "Track your progress, strengths, and areas to improve." },
  { title: "Gamified learning", icon: "🎮", description: "Earn points and badges while enjoying learning challenges." },
];
      ...
      <section className="relative flex flex-col md:flex-row items-center justify-center min-h-screen py-28 md:py-32 w-full overflow-hidden bg-gray-50">
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-center w-full max-w-7xl mx-auto px-4 md:px-8 space-y-20 md:space-y-0 md:space-x-16">
          ...
          <div className="md:w-1/2 text-center md:text-left space-y-8 flex flex-col items-center md:items-start">
            ...
            >
              <button className="w-full sm:w-auto px-8 py-4 rounded-full bg-gradient-to-r from-emerald-400 to-rose-400 text-white font-semibold text-lg shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300">
                Get Started
              </button>
